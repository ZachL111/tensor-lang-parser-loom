...
`tensor-lang-parser-loom` is centered on compilers work in Julia. The technical target is: Create a Julia reference implementation for parser workflows, centered on diagnostic reporting, negative fixtures, and human-readable error snapshots.
...
The score is deterministic. The current threshold is 152. Risk has a penalty of 5, latency has a penalty of 3, and weight contributes a bonus of 2.
