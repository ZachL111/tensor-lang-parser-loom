"""Regression checks for the tensor-lang-parser-loom casebook."""
...
from casebook.harness import assert_expected, tensor_lang_parser_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tensor_lang_parser_loom_summary(), assert_expected())
